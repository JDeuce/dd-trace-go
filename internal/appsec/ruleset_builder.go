...
type (
	...
	// identifier represents an entity that has a string element allowing to identify it.
	// This allows making sure that we can compare elements based on their ID in a generic merge function
...
// mergeIdentifiers merges two slices of elements that implement the `identifier` interface
